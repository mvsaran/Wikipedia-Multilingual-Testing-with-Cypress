...
var require_guard = __commonJS({
  "../utils/dist/guard.js"(exports) {
    ...
    function isFunction(value, { name, strict = true }) {
      if ((strict || !types6.isNull(value)) && !types6.isFunction(value)) {
...
var require_general = __commonJS({
  "../utils/dist/general.js"(exports) {
    ...
    function getEnvCaseInsensitive(key) {
      ...
      return foundKey ? process.env[foundKey] : void 0;
    }
    ...
    function extend(target, extension) {
      ...
      return Object.defineProperties(result, {
        ...Object.fromEntries(Object.entries(Object.getOwnPropertyDescriptors(target)).map(([key, descriptor]) => [
          key,
          types6.isFunction(descriptor.value) || types6.isObject(descriptor.value) ? descriptor : {
    ...
    function _deepEqual(value1, value2, visitedObjects) {
      ...
      if (types6.isArray(value1) && types6.isArray(value2)) {
        if (value1.length !== value2.length)
          return false;
        for (let i2 = 0; i2 < value1.length; i2++) {
          if (!_deepEqual(value1[i2], value2[i2], visitedObjects))
            return false;
        }
        return true;
      }
      if (types6.isObject(value1) && types6.isObject(value2)) {
...
var require_geometry = __commonJS({
  "../utils/dist/geometry.js"(exports) {
    ...
    function isIntersected(region1, region2) {
      return (region1.x <= region2.x ? region2.x < region1.x + region1.width : region1.x < region2.x + region2.width) && (region1.y <= region2.y ? region2.y < region1.y + region1.height : region1.y < region2.y + region2.height);
    }
...
// ../utils/dist/snippets/capture-canvas-disable-preserve-drawing-buffer.js
var require_capture_canvas_disable_preserve_drawing_buffer = __commonJS({
  "../utils/dist/snippets/capture-canvas-disable-preserve-drawing-buffer.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// ../utils/dist/snippets/capture-canvas-enable-preserve-drawing-buffer.js
var require_capture_canvas_enable_preserve_drawing_buffer = __commonJS({
  "../utils/dist/snippets/capture-canvas-enable-preserve-drawing-buffer.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// ../utils/dist/snippets/capture-canvas-image-always.js
var require_capture_canvas_image_always = __commonJS({
  "../utils/dist/snippets/capture-canvas-image-always.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function captureImagesFunc() {
      async function isNonBlackImage(dataUrl) {
        ...
        for (let i2 = 0; i2 < imageData.length; i2 += 4) {
          if (imageData[i2] !== 0 || imageData[i2 + 1] !== 0 || imageData[i2 + 2] !== 0) {
            return true;
          }
        }
        return false;
      ...
      function patchRequestAnimationFrame(win) {
        ...
        const HTMLCanvasElementCtor = win.HTMLCanvasElement || win.constructor && win.constructor.HTMLCanvasElement || win.document && ((_a4 = win.document.defaultView) === null || _a4 === void 0 ? void 0 : _a4.HTMLCanvasElement);
...
// ../utils/dist/snippets/index.js
var require_snippets = __commonJS({
  "../utils/dist/snippets/index.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? function(o, m2, k, k2) {
      if (k2 === void 0)
        k2 = k;
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    __exportStar(require_capture_canvas_disable_preserve_drawing_buffer(), exports);
    __exportStar(require_capture_canvas_enable_preserve_drawing_buffer(), exports);
    __exportStar(require_capture_canvas_image_always(), exports);
  }
});
...
var require_dist = __commonJS({
  "../utils/dist/index.js"(exports) {
    ...
    exports.snippets = __importStar(require_snippets());
  }
});
...
var require_common = __commonJS({
  "../../node_modules/http-proxy-agent/node_modules/debug/src/common.js"(exports, module2) {
    function setup(env) {
...
var require_browser = __commonJS({
  "../../node_modules/http-proxy-agent/node_modules/debug/src/browser.js"(exports, module2) {
...
var require_node = __commonJS({
  "../../node_modules/http-proxy-agent/node_modules/debug/src/node.js"(exports, module2) {
    var tty = require("tty");
...
var require_src = __commonJS({
  "../../node_modules/http-proxy-agent/node_modules/debug/src/index.js"(exports, module2) {
...
var require_src2 = __commonJS({
  "../../node_modules/http-proxy-agent/node_modules/agent-base/dist/src/index.js"(exports, module2) {
    "use strict";
...
var require_common2 = __commonJS({
  "../../node_modules/https-proxy-agent/node_modules/debug/src/common.js"(exports, module2) {
    function setup(env) {
      createDebug.debug = createDebug;
      createDebug.default = createDebug;
      createDebug.coerce = coerce;
...
var require_browser2 = __commonJS({
  "../../node_modules/https-proxy-agent/node_modules/debug/src/browser.js"(exports, module2) {
    exports.formatArgs = formatArgs;
    exports.save = save;
    exports.load = load;
    exports.useColors = useColors;
...
var require_node2 = __commonJS({
  "../../node_modules/https-proxy-agent/node_modules/debug/src/node.js"(exports, module2) {
    var tty = require("tty");
    var util = require("util");
    exports.init = init;
    exports.log = log;
...
var require_src3 = __commonJS({
  "../../node_modules/https-proxy-agent/node_modules/debug/src/index.js"(exports, module2) {
    if (typeof process === "undefined" || process.type === "renderer" || process.browser === true || process.__nwjs) {
...
var cachify = utils2.general.cachify;
var disableHttpAgentReuse = process.env.APPLITOOLS_DISABLE_AGENT_CACHIFY;
var cachifiedCreateHttpsProxyAgent = cachify((options) => {
  const agent = (0, import_https_proxy_agent.default)(options);
  agent.callback = utils2.general.wrap(agent.callback.bind(agent), (fn, request, options2, ...rest) => {
    return fn(request, { ...options2, rejectUnauthorized: false }, ...rest);
  });
  return agent;
});
var cachifiedCreateHttpProxyAgent = cachify(import_http_proxy_agent.default);
var cachifiedNewHttpsAgent = cachify((options) => new import_https.Agent(options));
var cachifiedNewHttpAgent = cachify((options) => new import_http.Agent(options));
function makeAgent(options) {
  var _a4;
  (_a4 = options.keepAliveOptions) !== null && _a4 !== void 0 ? _a4 : options.keepAliveOptions = {
    keepAlive: true
  };
  ...
  return function agent(url) {
    ...
    if (proxyOptions) {
      ...
      proxyUrl.username = (_a5 = proxyOptions.username) !== null && _a5 !== void 0 ? _a5 : proxyUrl.username;
      proxyUrl.password = (_b = proxyOptions.password) !== null && _b !== void 0 ? _b : proxyUrl.password;
      const options2 = { ...(0, import_url.parse)(proxyUrl.href), rejectUnauthorized: false, lookup: lookup2 };
      if (url.protocol === "https:") {
        if (disableHttpAgentReuse) {
          const agent2 = (0, import_https_proxy_agent.default)(options2);
          agent2.callback = utils2.general.wrap(agent2.callback.bind(agent2), (fn, request, options3, ...rest) => {
            return fn(request, { ...options3, rejectUnauthorized: false }, ...rest);
          });
          return agent2;
        }
        return cachifiedCreateHttpsProxyAgent(options2);
      } else if (url.protocol === "http:") {
        if (disableHttpAgentReuse) {
          return (0, import_http_proxy_agent.default)(options2);
        }
        return cachifiedCreateHttpProxyAgent(options2);
      }
    } else if (url.protocol === "https:") {
      if (disableHttpAgentReuse) {
        return new import_https.Agent({ rejectUnauthorized: false, lookup: lookup2, ...keepAliveOptions });
      }
      return cachifiedNewHttpsAgent({ rejectUnauthorized: false, lookup: lookup2, ...keepAliveOptions });
    } else if (url.protocol === "http:") {
      if (disableHttpAgentReuse) {
        return new import_http.Agent({ lookup: lookup2, ...keepAliveOptions });
      }
      return cachifiedNewHttpAgent({ lookup: lookup2, ...keepAliveOptions });
    }
  };
}
...
var disableHttpAgentReuse2 = process.env.APPLITOOLS_DISABLE_AGENT_CACHIFY;
...
async function req(input, ...requestOptions) {
  ...
  else if (!disableHttpAgentReuse2)
    options.headers = {};
  if (!disableHttpAgentReuse2) {
...
function calculateTimeout(requestTimeout, body, options) {
  ...
  if (utils3.types.isNumber(requestTimeout))
    return requestTimeout;
  if (utils3.types.isPlainObject(requestTimeout)) {
    const { base, perByte } = requestTimeout;
    if (utils3.types.isString(body))
      return base + perByte * body.length;
    if (utils3.types.isArray(body))
      return base + perByte * body.reduce((acc, item) => acc + item.length, 0);
    if (utils3.types.instanceOf(body, ArrayBuffer))
      return base + perByte * body.byteLength;
    if (utils3.types.instanceOf(body, Uint8Array) || utils3.types.instanceOf(body, Uint16Array) || utils3.types.instanceOf(body, Uint32Array))
      return base + perByte * body.byteLength;
    if (global.Blob && utils3.types.instanceOf(body, Blob))
      return base + perByte * body.size;
    if (global.Buffer && utils3.types.instanceOf(body, import_buffer.Buffer))
      return base + perByte * body.byteLength;
    const allHooks = (_a4 = options === null || options === void 0 ? void 0 : options.hooks) !== null && _a4 !== void 0 ? _a4 : [];
    allHooks.forEach((hooks) => {
      var _a5;
      (_a5 = hooks.unknownBodyType) === null || _a5 === void 0 ? void 0 : _a5.call(hooks, { body, options });
    });
