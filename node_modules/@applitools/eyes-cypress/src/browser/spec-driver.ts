...
export function executeScript(context: Context, script: string, arg: any): any {
  ...
  } else if (script.startsWith('applitools:')) {
    // prevents "SyntaxError: Unexpected token 'return'\n    at new Function (<anonymous>)" from appearing in the devtool
    return
  } else {
...
export function parentContext(context: Context): Context {
  ...
  if (!context) throw new Error('Context is not accessible')
